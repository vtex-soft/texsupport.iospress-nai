...
- `nai_template.tex` - the main template file should be used for article preparation;
...
- `nai_template.bbl` is a sample bibliography file created by BibTeX using the `ios1.bst` file.

## Setup

- Clone the repository or download the `.zip` archive;
- Read the instructions (`iosart2x.pdf`) for the preparation of your LaTeX document;
- Use the template file `nai_template.tex` to prepare your manuscript.
